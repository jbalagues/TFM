...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
       ...
       // resources.add(com.uoc.tfm.rest.jaxrs.resource.MessageResource.class);
       // resources.add(com.uoc.tfm.rest.jaxrs.resource.PersonResource.class);
        resources.add(com.uoc.tfm.rest.jaxrs.resource.TransporteController.class);
